...
;; -------
;;
;; 2017-06-06     (not (arrayp ttt--state))
;; 2017-05-29 1.2 ttt-jump-to-char-forward, ttt-jump-to-char-backward
;; 2017-05-26 1.1 ttt-table autogenerated by mktable.pl
;; 2017-05-24 1.0 Refactoring
;; 2016-08-31 0.9
;; 2014-08-24 0.8
;; 2014-04-21 0.7
;; 2013-06-04 0.6
...
;; 2005-01-23
;; 2004-12-27
;; 2004-12-14 0.0 Initial version
...
(defvar ttt-keys "1234567890qwertyuiopasdfghjkl;zxcvbnm,./"
  "*Set of keys that make T-Code string.")

(defvar ttt-delimiter ?:
  "*Delimiter that sets boundary of T-Code string scanning.")
...
getting body (i.d. T-Code string), decode body and return resulting
...
If input char is Return (or C-m), then read T-Code keys as input char."
  (interactive "p")
